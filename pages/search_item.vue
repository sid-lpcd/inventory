...
<script>
  export default {
    ...
    async fetch(){
        this.hazards_list = await this.$axios.$get('https://zen-brown-d8c780.netlify.app/api/allhazards')
    ...
    methods:{
        ...
        async getItem(){
            ...
            switch (sel) {
                ...
                case 'Id':
                    temp = await this.$axios.$get('https://zen-brown-d8c780.netlify.app/api/ItemById',{ params: { searchString: search } })
                    break;
                case 'Date of Entry':
                    temp = await this.$axios.$get('https://zen-brown-d8c780.netlify.app/api/ItemByDate',{ params: { start: startDate, end: endDate } })
                    break;
                case 'Hazards':
                    temp = await this.$axios.$get('https://zen-brown-d8c780.netlify.app/api/ItemByHazard',{ params: { searchString: this.selected_hazards } })
                    break;
            }
    	    ...
    	    for( let i = 0; i <temp.length; i++ ){
                const hazArr = await this.$axios.$get('https://zen-brown-d8c780.netlify.app/api/HazardsInItem',{ params: { searchString: temp[i].id } })
