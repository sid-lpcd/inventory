...
pytesseract.pytesseract.tesseract_cmd = r'C:\Users\sidon\AppData\Local\Programs\Tesseract-OCR\tesseract.exe'
...
class ImageDataFinder():
    ...
    def getData(self):
        ...
        # a dictionary
        data = json.load(f)
        print(data['chemicals'][0]['measure'])
        print(data['chemicals'][0]['unit'])
        print(data['chemicals'][0]['name'])
        for hazard in data['chemicals'][0]['hazards']:
            print(hazard)